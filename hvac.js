...
<p>Here's the thing: most HVAC businesses miss 3-5 calls per day. Each missed call could be a $300-500 job.</p>
...
// REAL UK HVAC - VERIFIED
const businesses = [
  { name: "R. Perkins & Co", email: 'info@rperkins.co.uk', city: 'London', type: 'HVAC' },
  { name: "Ambiento", email: 'info@ambiento.co.uk', city: 'London', type: 'HVAC' },
  { name: "Mountair", email: 'info@mountair.co.uk', city: 'London', type: 'HVAC' },
  { name: "HVAC Rentals", email: 'info@hvacrentals.co.uk', city: 'London', type: 'HVAC' },
  { name: "Balmech", email: 'info@balmech.co.uk', city: 'London', type: 'HVAC' },
  { name: "ElectricalServ", email: 'office@electricalserv.uk', city: 'Leeds', type: 'HVAC' },
  { name: "R Pearson Electrical", email: 'info@rpearsonelectrical.co.uk', city: 'Leeds', type: 'HVAC' },
  { name: "SGT Electrical", email: 'info@sgtelectrical.co.uk', city: 'Birmingham', type: 'HVAC' },
  { name: "Emergency Electrician 247", email: 'info@emergencyelectrician247.co.uk', city: 'Birmingham', type: 'HVAC' },
];
